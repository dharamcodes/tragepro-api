...
class TradingServiceImplTest {
    ...
    void testOpenPosition_NullRequest() {
        AppException exception = assertThrows(AppException.class, () -> tradingService.openPosition(null));
    ...
    void testGetPosition_NullId() {
        AppException exception = assertThrows(AppException.class, () -> tradingService.getPosition(null));
        assertEquals(ErrorType.INVALID_PARAMETER, exception.getErrorType());
    }

    @Test
    void testGetPosition_NotFound() {
        AppException exception = assertThrows(AppException.class, () -> tradingService.getPosition("non-existent"));
    ...
    void testGetActivePositions() {
        ...
        TradePositionRequest req1 = new TradePositionRequest("AAPL", BigDecimal.TEN, BigDecimal.valueOf(150.0), "BUY");
