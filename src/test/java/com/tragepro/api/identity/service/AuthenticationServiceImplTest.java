...
import com.tragepro.api.identity.service.impl.AuthenticationServiceImpl;
...
class AuthenticationServiceImplTest {
  ...
  @Mock private MapperFactory<AuthenticationMapper> mapperFactory;
  ...
  void testSignup_Success() {
    ...
    when(mapperFactory.getMapper(MapperType.AUTHENTICATION_MAPPER))
        .thenReturn(authenticationMapper);
