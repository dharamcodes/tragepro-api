...
import com.tragepro.api.identity.internal.helper.JwtTokenHelper;
...
/** Service implementation managing user account profiles and details persistence. */
@Slf4j
@Service
@AllArgsConstructor
public class AccountDetailServiceImpl implements AccountDetailService {
  ...
  /**
   * Creates a new user account profile and links it to the authenticated user.
   *
   * @param accountDetailRequest request payload
  ...
  /**
   * Updates account details by identifier.
   *
   * @param identifier account identifier
   * @param accountDetailRequest updated request payload
   * @return account detail response
   */
  @Override
  ...
  /**
   * Deactivates account by identifier.
   *
   * @param identiFier account identifier
   */
  @Override
