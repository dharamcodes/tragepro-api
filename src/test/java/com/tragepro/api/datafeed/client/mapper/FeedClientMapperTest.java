package com.tragepro.api.datafeed.client.mapper;
...
class FeedClientMapperTest {
  ...
  void testMap_NullResponseOrRequest() {
    ...
    assertTrue(
        mapper
            .map(new FeedClientResponse(null, null, null, null, null, null, null), null)
            .isEmpty());
  }
  ...
  void testMap_Success() {
    FeedClientRequest request = FeedClientRequest.builder().instrument("EQUITY").build();
    FeedClientResponse response =
  ...
  void testMap_MissingValuesFallback() {
    FeedClientRequest request = FeedClientRequest.builder().instrument("EQUITY").build();
    FeedClientResponse response =
        new FeedClientResponse(null, null, null, null, null, List.of(1600000000L), null);
