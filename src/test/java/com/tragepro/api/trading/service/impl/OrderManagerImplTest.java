...
class OrderManagerImplTest {
    ...
    void testSubmitOrder_Success() {
        OrderRequest request = new OrderRequest("AAPL", BigDecimal.TEN, BigDecimal.valueOf(150.0), "LIMIT", "BUY");
    ...
    void testGetOrderStatus_NullId() {
        AppException exception = assertThrows(AppException.class, () -> orderManager.getOrderStatus(null));
        assertEquals(ErrorType.INVALID_PARAMETER, exception.getErrorType());
    }

    @Test
    void testGetOrderStatus_NotFound() {
        AppException exception = assertThrows(AppException.class, () -> orderManager.getOrderStatus("non-existent"));
    ...
    void testCancelOrder_NotFound() {
        AppException exception = assertThrows(AppException.class, () -> orderManager.cancelOrder("non-existent"));
        assertEquals(ErrorType.DATA_NOT_FOUND, exception.getErrorType());
    }
}
