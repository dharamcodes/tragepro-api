package com.tragepro.api.journal.service.impl;
...
import com.tragepro.api.journal.core.repository.JournalRepository;
import com.tragepro.api.journal.service.mapper.JournalMapper;
...
class JournalServiceImplTest {
    ...
    void setUp() {
        ...
        response = JournalResponse.builder()
                .id(testId)
                .accountId(accountId)
                .symbol("AAPL")
                .tradeType(TradeType.LONG)
    ...
    void testUpdateJournal_NotFound() {
        ...
        AppException ex = assertThrows(AppException.class, () -> journalService.updateJournal(testId, request));
        assertEquals(ErrorType.DATA_NOT_FOUND, ex.getErrorType());
        verify(journalRepository, times(1)).findById(testId);
